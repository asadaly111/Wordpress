...
function reason_for_cancellation__save( $post_id ) {
	...
	$headers = array('Content-Type: text/html; charset=UTF-8');
		...
		wp_mail( get_user_email_by_id($post->post_author),'Published Directory', '<table style="width: 610px; background-color: #fff; display: table; margin: auto;">
	<tbody>
        <tr>
        <td>
            ...
            <table style="width: 563px; display: table; margin: auto; background-color: #f2f2f2;">
                <tbody>
                    ...
                    <td style="padding: 70px 0px 70px 0;">
                        <h2 style=" font-size: 20px; color: #4d4d4d; font-family:Gotham, Helvetica Neue, Helvetica, Arial, sans-serif;  margin: 0px 0 30px 0; text-align: center; font-weight:600;">Published Directory</h2>
	   ...
	   <table style="width: 563px; display: table; margin: auto;">
		...
		wp_mail( get_user_email_by_id($post->post_author),'Rejected Directory', 'Rejected Directory');
	}
