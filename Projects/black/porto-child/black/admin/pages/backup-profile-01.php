	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a href="javascript:;" id="deactivate_ID" data-id="<?php echo $key->ID;  ?>" class="btn btn-3d btn-primary btn-xs mb-2">Deactivate Profile</a>
			</td>
		</tr>
		<?php endforeach ?>
		<?php endif ?>
...
<h1>Client Profile</h1>
	<div class="proff">
		<div class="row">
			<div class="col-md-3">
				<img src="<?php echo bloginfo('template_url');?>/images/Group11.png" alt="" class="img-fluid profile" >
			</div>
		</div>
	</div>
</div>
