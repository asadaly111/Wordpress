...
$post_thumbnail_id = get_post_thumbnail_id($id); $thumbnail = wp_get_attachment_image_src($post_thumbnail_id ,'thumbnail', false); 
if (empty($thumbnail)) {
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="faq-nav">
                                <nav>
                                    <ul class="tabss">
                                        <li class="active"><a href="javascript:;" data-classname="profile">Profile</a></li>
                                        <li class=""><a href="javascript:;" data-classname="gallery">Gallery</a></li>
                                        <li class=""><a href="javascript:;" data-classname="video">Videos</a></li>
                                        <li class=""><a href="javascript:;" data-classname="reviews">Reviews</a></li>
                                        <li><a href="javascript:;" data-classname="contact">Contact</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-9 col-lg-9">
                                                                <h6 class="text-center"><?php echo get_the_title(get_the_ID()); ?></h6>
                                                            </div>
                                                        </div> 
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-3 col-lg-3">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-9 col-lg-9">
                                                                <h6 class="text-center"><?php echo $black_age; ?></h6>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-3 col-lg-3">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-9 col-lg-9">
                                                                <h6 class="text-center"><?php echo $black_hair; ?></h6>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-3 col-lg-3">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-9 col-lg-9">
                                                                <h6 class="text-center"><?php echo $black_weight; ?></h6>
                                                            </div>
                                                        </div> 
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-3 col-lg-3">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-9 col-lg-9">
                                                                <h6 class="text-center"><?php echo $black_height; ?></h6>
                                                            </div>
                                                        </div>   
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-9 col-lg-9">
                                                                <h6 class="text-center"><?php echo $black_rates; ?></h6>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-3 col-lg-3">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-9 col-lg-9">
                                                                <h6 class="text-center"><?php echo strtoupper($black_travel); ?></h6>
                                                            </div>
                                                        </div>                                                                                                               
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-9 col-lg-9">
                                                                <h6 class="text-center"><?php echo $black_ethnicity; ?></h6>
                                                            </div>
                                                        </div> 
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-3 col-lg-3">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-6 col-xl-9 col-lg-9">
                                                                <h6 class="text-center"><?php echo $black_wroking_hours; ?></h6>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="address-details">
                                        ...
                                        <div class="address-details-inner">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-6  col-xl-9 col-lg-9">
                                                    <h6><?php echo strtoupper($black_smoker); ?></h6>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-6  col-xl-3 col-lg-3">
                                    ...
                                    <div class="contact-details">
                                        ...
                                        <div class="contact-details-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-6  col-xl-9 col-lg-9">
                                                    <h6><?php echo $obj->get_user_email_by_id($post->post_author); ?></h6>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-6  col-xl-3 col-lg-3">
                            ...
                            <div class="tab-contentss main con-contact-admin-form-main" id="contact">
                                <div class="con-contact-admin-form">
                                    ...
                                    <?php if (is_user_logged_in()):
                                        require 'templates/black_message.php';                                        
                                    else:
                                        echo "Please Login to send message!";
                                    endif; ?>
