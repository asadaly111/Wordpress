...
// step 4 hits
        jQuery(document).on('submit', '.durationsubmnit', function(event) {
            ...
            var duration = jQuery(this).find('input[name="duration"]:checked').data('duration');
            var price = jQuery(this).find('input[name="duration"]:checked').data('price');
            ...
            axios.get('<?php echo Easy_URL . 'template/steps/slots_append.php'; ?>')
                .then(function (response) {
