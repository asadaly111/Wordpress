	...
	if($has_error == FALSE) {
		    ...
		    $message	 = '<div align="center">
							<table width="600" cellspacing="5" cellpadding="5" border="0" style="color:#666 !important;background:none repeat scroll 0% 0% rgb(255,255,255);border-radius:3px;border:1px solid rgb(236,233,233)">
								<tbody>
								    <tr><td style="text-align:center"><img src="https://www.smacksandsmooches.com/wp-content/uploads/2017/10/smackkkk.png" height="100px" align="center" class="CToWUd a6T" tabindex="0"><div class="a6S" dir="ltr" style="opacity: 0.01; left: 842.641px; top: 334px;"><div id=":14o" class="T-I J-J5-Ji aQv T-I-ax7 L3 a5q" title="Download" role="button" tabindex="0" aria-label="Download attachment " data-tooltip-class="a1V"><div class="aSK J-J5-Ji aYr"></div></div></div></td></tr>
									<tr>
									<th style="background-color:#8aca02;color:white">Hello '.$firstname.'</th>
									</tr>
									<tr>
									...
									<tr><td><br>Regards,<br><b>smacksandsmooches.com</b></td></td></tr>
								</tbody>
							</table>
						</div>
						';
